...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'photos', label: 'Ảnh sự kiện', icon: 'camera' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'system', label: 'Cài đặt hệ thống', icon: 'gear' },
    ],
  },
]
