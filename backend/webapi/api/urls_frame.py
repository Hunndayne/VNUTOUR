...
from api.views_frame import (
    public_frames_view, public_frame_detail_view, public_frame_image_view, public_frame_download_view,
...
urlpatterns = [
    ...
    path("public/frames/", public_frames_view),
    path("public/frames/<int:frame_id>", public_frame_detail_view),
    path("public/frames/<int:frame_id>/", public_frame_detail_view),
